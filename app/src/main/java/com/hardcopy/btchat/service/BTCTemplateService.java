...
import com.hardcopy.btchat.AccountActivity;
import com.hardcopy.btchat.MainActivity;
import com.hardcopy.btchat.WaitActivity;
...
public class BTCTemplateService extends Service {
	...
	public static final String BROADCAST_ACTION = "com.hardcopy.btchat.update";
			...
			case BluetoothManager.MESSAGE_READ:
				...
				if(msg.arg1 > 0) {
					...
					if(strMsg.contains("\r\n")) {
						...
						if(message.matches("[0-9]+") && "com.hardcopy.btchat.AccountActivity".equals(className)){

							Intent broadIntent = new Intent(BROADCAST_ACTION);
							broadIntent.putExtra("amount", message);
							sendBroadcast(broadIntent);
						}
						else if(!message.matches("[0-9]+") && "com.hardcopy.btchat.WaitActivity".equals(className)){
